...
public class TodoSimulator extends SimulatorRestAdapter {

    public static void main(String[] args) {
        SpringApplication.run(TodoSimulator.class, args);
    }
    ...
    public static HttpScenarioGenerator scenarioGenerator() {
        HttpScenarioGenerator generator = new HttpScenarioGenerator(new ClassPathResource("static/swagger.json"));
        generator.setContextPath("/todo");
        return generator;
    }
}
